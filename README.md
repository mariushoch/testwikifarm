...
## DNS rebinding
As `*.local.wmftest.net` is a public domain that resolves to localhost, [DNS rebinding protection](https://en.wikipedia.org/wiki/DNS_rebinding#DNS_Based) might interfere when attempting to resolve it.
